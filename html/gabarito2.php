            ...
            <div id="alca-camiseta" class="mb-5">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-vDDZ8cVlSXLvyAJkGY6Uqsg2KvQtLh.png" alt="Template 25x35" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">25x35</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
                                    </a>
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-text me-2"></i>AI
                                        <i class="bi bi-download ms-2 download-icon"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-vDDZ8cVlSXLvyAJkGY6Uqsg2KvQtLh.png" alt="Template 30x40" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">30x40</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
                    ...
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-vDDZ8cVlSXLvyAJkGY6Uqsg2KvQtLh.png" alt="Template 40x50" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">40x50</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
            ...
            <div id="alca-vazada" class="mb-5">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-10CAbQU2npNWAEKGZMuIoGFAvGyCwA.png" alt="Template 20x30" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">20x30</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
                    ...
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-10CAbQU2npNWAEKGZMuIoGFAvGyCwA.png" alt="Template 30x40" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">30x40</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
            ...
            <div id="cartao" class="mb-5">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-10CAbQU2npNWAEKGZMuIoGFAvGyCwA.png" alt="Cartão de Visita" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">9x5 cm</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
            ...
            <div id="sacolas">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-10CAbQU2npNWAEKGZMuIoGFAvGyCwA.png" alt="Template 18x23x9" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">18x23x9</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
                    ...
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-10CAbQU2npNWAEKGZMuIoGFAvGyCwA.png" alt="Template 21x27x9" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">21x27x9</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
                    ...
                    <div class="col-md-4">
                        <div class="card template-card">
                            <div class="card-body text-center">
                                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-10CAbQU2npNWAEKGZMuIoGFAvGyCwA.png" alt="Template 25x34x10" class="img-fluid mb-3" style="max-height: 200px;">
                                <h3 class="h5 mb-3">25x34x10</h3>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="#" class="btn btn-outline-primary">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>PDF
                                        <i class="bi bi-download ms-2 download-icon"></i>
