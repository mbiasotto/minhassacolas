            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="product-details p-4 border rounded">
                        ...
                        <p>Nossas sacolas de papel personalizadas são produzidas com materiais de alta qualidade, garantindo 
                        resistência e um acabamento premium. Ideais para lojas, eventos e embalagens de presente, 
                        nossas sacolas valorizam sua marca e proporcionam uma experiência diferenciada aos seus clientes.</p>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6 mb-4 mb-md-0 animate animate-up">
                                <div class="feature-box h-100 p-4 border rounded bg-light">
                                    ...
                                    <ul class="feature-list">
                                        <li>Papel de alta qualidade</li>
                                        <li>Impressão colorida de alta definição</li>
                                        <li>Material sustentável</li>
                                        <li>Acabamento premium</li>
                                        <li>Diversos tamanhos disponíveis</li>
                                        <li>Personalização completa</li>
                                        <li>Opções de alças e acabamentos</li>
                                        <li>Laminação fosca ou brilhante opcional</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 animate animate-up">
                                <div class="feature-box h-100 p-4 border rounded bg-light">
                                    ...
                                    <ul class="feature-list">
                                        <li>Lojas de roupas e calçados</li>
                                        <li>Joalherias e acessórios</li>
                                        <li>Lojas de presentes</li>
